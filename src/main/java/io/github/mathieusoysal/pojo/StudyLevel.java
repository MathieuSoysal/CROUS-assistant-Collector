...
class StudyLevel {
    ...
    public StudyLevel withMin(Object min) {
        this.min = min;
        return this;
    }
    ...
    public StudyLevel withMax(Object max) {
        this.max = max;
        return this;
    }
    ...
    public StudyLevel withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(StudyLevel.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
                .append('[');
        sb.append("min");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof StudyLevel) == false) {
            return false;
        }
        StudyLevel rhs = ((StudyLevel) other);
