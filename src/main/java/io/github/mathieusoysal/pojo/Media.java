...
public class Media {
    ...
    public Media withSrc(String src) {
        this.src = src;
        return this;
    }
    ...
    public Media withDescription(Object description) {
        this.description = description;
        return this;
    }
    ...
    public Media withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Media.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
                .append('[');
        sb.append("src");
        sb.append('=');
