...
class Sector {
    ...
    public Sector withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public Sector withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Sector.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
                .append('[');
        sb.append("id");
        sb.append('=');
